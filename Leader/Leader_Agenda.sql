...
INSERT INTO Types
(Type, Kind)
VALUES ('TRAIT_AGENDA_PATCHERESU_SOLUS', 'KIND_TRAIT');
...
VALUES (
    'AGENDA_PATCHERESU_SOLUS',
    'LOC_AGENDA_PATCHERESU_SOLUS_NAME',
...
VALUES ('AGENDA_PATCHERESU_SOLUS', 'TRAIT_AGENDA_PATCHERESU_SOLUS');
...
VALUES ('LEADER_PATCHERESU_SOLUS', 'AGENDA_PATCHERESU_SOLUS');
...
(Agendaone, Agendatwo)
VALUES ('AGENDA_PATCHERESU_SOLUS', 'AGENDA_DEVOUT');
...
VALUES (
    'TRAIT_AGENDA_PATCHERESU_SOLUS', 'AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY'
),
('TRAIT_AGENDA_PATCHERESU_SOLUS', 'AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY');
...
VALUES (
    'AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY',
    'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',
    'REQSET_PATCHERESU_SOLUS_UNHAPPY'
),
(
    'AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY',
    'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',
    'REQSET_PATCHERESU_SOLUS_HAPPY'
);
...
VALUES (
    'AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY',
    'Sample',
    'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'
),
(
    'AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY',
    'Sample',
...
VALUES ('AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY', 'InitialValue', -5),
('AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY', 'IncrementValue', -1),
('AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY', 'IncrementTurns', -10),
('AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY', 'MaxValue', -25),
(
    'AGENDA_MODIFIER_PATCHERESU_SOLUS_UNHAPPY',
    'StatementKey',
...
('AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY', 'InitialValue', 5),
('AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY', 'IncrementValue', 1),
('AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY', 'IncrementTurns', 10),
('AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY', 'MaxValue', 12),
(
    'AGENDA_MODIFIER_PATCHERESU_SOLUS_HAPPY',
    'StatementKey',
...
VALUES ('REQSET_PATCHERESU_SOLUS_UNHAPPY', 'REQUIREMENTSET_TEST_ALL'),
('REQSET_PATCHERESU_SOLUS_HAPPY', 'REQUIREMENTSET_TEST_ALL');
...
VALUES ('REQSET_PATCHERESU_SOLUS_UNHAPPY', 'REQUIRES_MAJOR_CIV_OPPONENT'),
('REQSET_PATCHERESU_SOLUS_UNHAPPY', 'REQUIRES_MET_10_TURNS_AGO'),
('REQSET_PATCHERESU_SOLUS_UNHAPPY', 'REQUIRES_HAS_LOW_HAPPINESS'),
('REQSET_PATCHERESU_SOLUS_HAPPY', 'REQUIRES_MAJOR_CIV_OPPONENT'),
('REQSET_PATCHERESU_SOLUS_HAPPY', 'REQUIRES_MET_10_TURNS_AGO'),
('REQSET_PATCHERESU_SOLUS_HAPPY', 'REQUIRES_HAS_HIGH_CULTURE'),
('REQSET_PATCHERESU_SOLUS_HAPPY', 'REQUIRES_HAS_HIGH_SCIENCE');
