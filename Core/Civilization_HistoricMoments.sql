...
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT',			'MOMENT_DATA_UNIT',				'UNIT_PATCHERESU_GUNSHIP',				'WerejaguarHistoricMoment.dds'		),
		('MOMENT_ILLUSTRATION_UNIQUE_IMPROVEMENT',	'MOMENT_DATA_IMPROVEMENT',		'IMPROVEMENT_CERULEUM_WELL',		'ColossalHeadHistoricMoment.dds'	),
		('MOMENT_ILLUSTRATION_UNIQUE_IMPROVEMENT',	'MOMENT_DATA_IMPROVEMENT',		'IMPROVEMENT_CERULEUM_RIG',		'ColossalHeadHistoricMoment.dds'	);
